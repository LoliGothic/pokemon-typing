...
function Game() {
    ...
    return (
        <div>
            <div className={classes.defaultFont}>下の英単語のどこかをクリックしたあとにスタートできます</div>
            <Box onKeyPress={(e) => handleKeyPress(e)} tabIndex={0} className={classes.inputBox}>
